...
const (
	RateService_GetRate_FullMethodName      = "/optiswift.proto.mint.RateService/GetRate"
	RateService_GetLiveRates_FullMethodName = "/optiswift.proto.mint.RateService/GetLiveRates"
)
...
type RateServiceClient interface {
	...
	GetLiveRates(ctx context.Context, in *GetLiveRatesRequest, opts ...grpc.CallOption) (*GetLiveRatesResponse, error)
}
...
func (c *rateServiceClient) GetLiveRates(ctx context.Context, in *GetLiveRatesRequest, opts ...grpc.CallOption) (*GetLiveRatesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetLiveRatesResponse)
	err := c.cc.Invoke(ctx, RateService_GetLiveRates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RateServiceServer interface {
	...
	GetLiveRates(context.Context, *GetLiveRatesRequest) (*GetLiveRatesResponse, error)
...
func (UnimplementedRateServiceServer) GetLiveRates(context.Context, *GetLiveRatesRequest) (*GetLiveRatesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetLiveRates not implemented")
}
...
func _RateService_GetLiveRates_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetLiveRatesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RateServiceServer).GetLiveRates(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RateService_GetLiveRates_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RateServiceServer).GetLiveRates(ctx, req.(*GetLiveRatesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "optiswift.proto.mint.RateService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetLiveRates",
			Handler:    _RateService_GetLiveRates_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "mint/rate.proto",
}
