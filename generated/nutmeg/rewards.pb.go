...
func (x *RewardSummary) GetDescription() string {
	if x != nil {
...
func (x *RewardSummary) GetRewardType() string {
	if x != nil {
		return x.RewardType
	}
	return ""
...
func (x *RewardSummary) GetRewardAmount() float32 {
	if x != nil {
...
var file_rewards_proto_rawDesc = []byte{
	...
	0x2e, 0x6e, 0x75, 0x74, 0x6d, 0x65, 0x67, 0x22, 0x95, 0x01, 0x0a, 0x0d, 0x52, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x53, 0x75, 0x6d, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x1c, 0x0a, 0x09, 0x72, 0x65, 0x66,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x77,
	...
	0x02, 0x52, 0x0c, 0x72, 0x65, 0x77, 0x61, 0x72, 0x64, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22,
...
var file_rewards_proto_depIdxs = []int32{
	0, // 0: optiswift.proto.nutmeg.FetchRewardSummaryResponse.rewards:type_name -> optiswift.proto.nutmeg.RewardSummary
	1, // 1: optiswift.proto.nutmeg.Rewards.FetchRewardSummary:input_type -> optiswift.proto.nutmeg.FetchRewardSummaryRequest
	2, // 2: optiswift.proto.nutmeg.Rewards.FetchRewardSummary:output_type -> optiswift.proto.nutmeg.FetchRewardSummaryResponse
