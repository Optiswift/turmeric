...
const (
	...
	RuleService_GetAllRules_FullMethodName      = "/optiswift.proto.nutmeg.RuleService/GetAllRules"
)
...
type RuleServiceClient interface {
	...
	GetAllRules(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllRulesResponse, error)
}
...
func (c *ruleServiceClient) GetAllRules(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllRulesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetAllRulesResponse)
	err := c.cc.Invoke(ctx, RuleService_GetAllRules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RuleServiceServer interface {
	...
	GetAllRules(context.Context, *emptypb.Empty) (*GetAllRulesResponse, error)
...
func (UnimplementedRuleServiceServer) GetAllRules(context.Context, *emptypb.Empty) (*GetAllRulesResponse, error) {
...
func _RuleService_GetAllRules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RuleServiceServer).GetAllRules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RuleService_GetAllRules_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RuleServiceServer).GetAllRules(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RuleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RuleService_GetAllRules_Handler,
		},
	},
